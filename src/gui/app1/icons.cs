...
public partial class ChronoJumpWindow 
{
	...
	Gtk.Image image_edit_selected_run_interval;
	...
	Gtk.Image image_force_sensor_analyze_options1;
	Gtk.Image image_force_sensor_analyze_options_close;
	Gtk.Image image_force_sensor_analyze_options_close1;
	...
	Gtk.Image image_force_sensor_analyze_options_close_and_analyze1;
	...
	private void putNonStandardIcons()
	{
		...
		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "persons_manage.png");
		//image_persons_manage.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_store_blue.png");//[By Joeries]
        image_menu_news.Pixbuf = pixbuf;
		image_menu_news1.Pixbuf = pixbuf;
		image_news_blue.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_store_yellow.png");//[By Joeries]
        ...
        if (Config.ColorBackgroundIsDark)
			pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_folders_yellow.png");//[By Joeries]

        pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_folders.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_help_yellow.png");
		image_help_yellow.Pixbuf = pixbuf;

		image_button_radio_encoder_exercise_help.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_book.png");
		image_menu_help_documents.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_keyboard.png");
		image_menu_help_shortcuts.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_about.png");
		image_menu_help_about.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_warning_red.png");
		image_message_permissions_at_boot.Pixbuf = pixbuf;
		image_button_force_sensor_stiffness_problem.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "muscle-excentric.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "extra-mass.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_sprint.png");
		image_tests_sprint.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "arrow_back.png");
		...
		if(Config.ColorBackgroundIsDark)
			pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_person_yellow.png");
		...
		image_person_manage_yellow.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_person_yellow.png");

		image_merge_persons.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "merge.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_test_inspect.png");
		image_test_inspect.Pixbuf = pixbuf;
		image_test_inspect1.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_chronopic_connect.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "folder_open_yellow.png");
		...
		/*
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_up.png");
		image_persons_up.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_down.png");
		...
		*/
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_rest_yellow.png");
		image_encoder_rest_time_clear_yellow.Pixbuf = pixbuf;
		image_contacts_rest_time_clear_yellow.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "folder_check.png");
		image_all_persons_events_h.Pixbuf = pixbuf;
		image_db_view.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "inertial_rolled.png");
		image_inertial_rolled.Pixbuf = pixbuf;
		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "inertial_half_rolled.png");
		//image_inertial_half_rolled.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "inertial_extended.png");
		image_inertial_extended.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "calibrate.png");
		image_encoder_calibrate.Pixbuf = pixbuf;
		image_encoder_recalibrate.Pixbuf = pixbuf;

		image_video_contacts_yes1.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_on.png");
		image_video_contacts_yes.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_on.png");
		image_video_encoder_yes.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_on.png");
		image_video_encoder_yes1.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_on.png");
		image_video_contacts_no.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_off.png");
		image_video_encoder_no.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_off.png");

		image_camera_at_boot.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "videocamera_off.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameIconTransp);
		image_logo_icon_transp.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_jump_2x.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_inertia_2x_2col.png");
		image_selector_start_inertial.Pixbuf = pixbuf;
		/*
		 * gui for small screens
		 */

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "start.png");
		image_start.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_jump_simple.png");
		image_mode_jumps_small1.Pixbuf = pixbuf;
		image_change_modes_contacts_jumps_simple.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_jump_reactive.png");
		...
		image_change_modes_contacts_force_sensor.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "isometric.png");
		image_change_modes_contacts_force_sensor1.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "elastic.png");
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "race_encoder_icon.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "run_photocell.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameJumpsFallCalculate);
		extra_windows_jumps_image_dj_fall_calculate.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameJumpsFallPredefined);
		extra_windows_jumps_image_dj_fall_predefined.Pixbuf = pixbuf;
		image_tab_jumps_dj_optimal_fall.Pixbuf = pixbuf;

		extra_window_jumps_image_fall.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_fall.png");
		extra_window_jumps_rj_image_fall.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_fall.png");
		extra_window_jumps_image_weight.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "extra-mass.png");
		extra_window_jumps_rj_image_weight.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "extra-mass.png");

		image_tab_jumps_weight_fv_profile.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "jumps-fv.png");
		image_tab_jumps_asymmetry.Pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "laterality-both.png");


		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "line_session_avg.png");
		image_line_session_avg.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "line_session_max.png");
		image_line_session_max.Pixbuf = pixbuf;
		
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "line_person_avg.png");
		image_line_person_avg.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "line_person_max.png");
		image_line_person_max.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "line_person_max_all_sessions.png");
		image_line_person_max_all_sessions.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameImport);//[By Joeries]
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_email.png");
		image_encoder_analyze_image_compujump_send_email_send.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_analyze_general.png");
		image_tests_analyze_general.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "jumps-profile-pie.png");
		image_tab_jumps_profile.Pixbuf = pixbuf;
		
		// execute tests --->
		/*
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "gtk-apply.png"); //trying high contrast (black)
		image_button_execute.Pixbuf = pixbuf;
		image_encoder_capture_execute.Pixbuf = pixbuf;
		*/

		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "finish.png"); //gnome (white)
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "floppy.png");
		image_button_finish.Pixbuf = pixbuf;
		image_encoder_capture_finish.Pixbuf = pixbuf;

		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "gtk-cancel.png"); //high contrast (black)
		//image_button_cancel.Pixbuf = pixbuf;
		//image_encoder_capture_cancel.Pixbuf = pixbuf;
		// <--- end of execute tests


		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeIndividualCurrentSetIcon);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeIndividualCurrentSessionIcon);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeIndividualAllSessionsIcon);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeGroupalCurrentSessionIcon);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeInstantaneousIcon);
		image_encoder_analyze_instantaneous.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeSideIcon);
		image_encoder_analyze_side.Pixbuf = pixbuf;
		image_encoder_analyze_selected_side.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeSuperposeIcon);
		image_encoder_analyze_superpose.Pixbuf = pixbuf;
		image_encoder_analyze_selected_superpose.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeSingleIcon);
		image_encoder_analyze_single.Pixbuf = pixbuf;
		image_encoder_analyze_selected_single.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeAllSetIcon);
		image_encoder_analyze_all_set.Pixbuf = pixbuf;
		image_encoder_analyze_selected_all_set.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeNmpIcon);
		image_encoder_analyze_nmp.Pixbuf = pixbuf;
		
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeEcconTogetherIcon);
		image_encoder_analyze_eccon_together.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeEcconSeparatedIcon);
		image_encoder_analyze_eccon_separated.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzePositionIcon);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeAccelIcon);
		image_encoder_analyze_accel.Pixbuf = pixbuf;
		image_encoder_analyze_show_SAFE_accel.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeForceIcon);
		image_encoder_analyze_force.Pixbuf = pixbuf;
		image_encoder_analyze_show_SAFE_force.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzePowerIcon);
		image_encoder_analyze_power.Pixbuf = pixbuf;
		image_encoder_analyze_show_SAFE_power.Pixbuf = pixbuf;
		
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeMeanIcon);
		image_encoder_analyze_mean.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeMaxIcon);
		image_encoder_analyze_max.Pixbuf = pixbuf;
		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeRangeIcon);
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzePositionIcon);
		image_encoder_analyze_range.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderAnalyzeTimeToPPIcon);
		image_encoder_analyze_time_to_pp.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameEncoderInertialInstructions);
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "image_check.png");
		image_encoder_analyze_check.Pixbuf = pixbuf;

		//auto mode
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameAutoPersonSkipIcon);
		image_auto_person_skip.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameAutoPersonRemoveIcon);
		image_auto_person_remove.Pixbuf = pixbuf;
				
		//pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + Constants.FileNameLogo320); //changed to 270 for the presentation
		//image_presentation_logo.Pixbuf = pixbuf;

		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "first.png");
		image_hscale_force_sensor_ai_a_first.Pixbuf = pixbuf;
		image_hscale_force_sensor_ai_b_first.Pixbuf = pixbuf;
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "left_cut.png");
		...
		pixbuf = Chronojump.MyPixbuf.Get(null, Util.GetImagePath(false) + "last.png");
	...
	private void connectWidgetsIcons (Gtk.Builder builder)
	{
		...
		image_edit_selected_run_interval = (Gtk.Image) builder.GetObject ("image_edit_selected_run_interval");
		...
		image_force_sensor_analyze_options1 = (Gtk.Image) builder.GetObject ("image_force_sensor_analyze_options1");
		image_force_sensor_analyze_options_close = (Gtk.Image) builder.GetObject ("image_force_sensor_analyze_options_close");
		image_force_sensor_analyze_options_close1 = (Gtk.Image) builder.GetObject ("image_force_sensor_analyze_options_close1");
		...
		image_force_sensor_analyze_options_close_and_analyze1 = (Gtk.Image) builder.GetObject ("image_force_sensor_analyze_options_close_and_analyze1");
